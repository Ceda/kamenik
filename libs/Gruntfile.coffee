  ...
  grunt.initConfig
    ...
    watch:
      ...
      sass:
        ...
        tasks: ["sass_globbing", "sass:development", "postcss"]
    ...
    sass_globbing:
      your_target:
        files:
          '<%= public_path %>/sass/frontend/_components.sass': '<%= public_path %>/sass/frontend/components/*.s*ss'
          '<%= public_path %>/sass/frontend/_layout.sass': '<%= public_path %>/sass/frontend/layout/*.s*ss'
          '<%= public_path %>/sass/frontend/_pages.sass': '<%= public_path %>/sass/frontend/pages/*.s*ss'
          '<%= public_path %>/sass/_frontend.sass': '<%= public_path %>/sass/frontend/*.s*ss'
    ...
    postcss:
      ...
      dist: src:  "<%= public_path %>/assets/css/*.css"
